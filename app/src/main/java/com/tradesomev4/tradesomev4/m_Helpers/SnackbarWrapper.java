...
/**
 * Created by Pastillas-Boy on 9/16/2016.
 */
public class SnackbarWrapper
{
    ...
    {
        final CoordinatorLayout snackbarContainer = new CoordinatorLayout(new ContextThemeWrapper(appplicationContext, R.style.AppTheme_Tradesome))
        {
            @Override
