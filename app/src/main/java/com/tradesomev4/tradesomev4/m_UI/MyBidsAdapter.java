 ...
 */
public class MyBidsAdapter extends RecyclerView.Adapter<MyBidsAdapter.MyBidsHolder> {
            ...
            public void onFinish() {
                ...
                if (!connectivity.isConnected()) {
                    ...
                    if (!isConnectionDisabledShowed) {
                        //nackBars.showConnectionDisabledDialog();
    ...
    public MyBidsAdapter(Context context, boolean isAttached, RecyclerView recyclerView, RequestManager glide,
        ...
        mDatabase.child("bidHistory").child(fUser.getUid()).addChildEventListener(new ChildEventListener() {
            @Override
    ...
    public MyBidsHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = inflater.inflate(R.layout.my_bids_model, parent, false);
    ...
    public void onBindViewHolder(final MyBidsHolder holder, int position) {
        ...
        bidsHistory.get(position).getAuctionId();
    ...
    public void initSwipe() {
        ItemTouchHelper.SimpleCallback simpleCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                final Bid bid = bidsHistory.get(pos);
                bidsHistory.remove(pos);
