...
import com.tradesomev4.tradesomev4.Filters.FollowingFilter;
...
public class FollowingAdapter extends RecyclerView.Adapter<FollowingAdapter.FollowingHolder> implements Filterable {
    ...
    String uid;
    private FirebaseUser fUser; RecyclerView recyclerView;
    boolean isAttached;
    ...
    public FollowingAdapter(Context context, String uid, boolean isAttached, RecyclerView recyclerView, RequestManager glide,
    ...
    public FollowingHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = inflater.inflate(R.layout.following_model, parent, false);
    ...
    public Filter getFilter() {
        if (filter == null) {
            filter = new FollowingFilter(followings, this);
        }
