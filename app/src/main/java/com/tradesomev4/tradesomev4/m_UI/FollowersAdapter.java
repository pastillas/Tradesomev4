...
import com.tradesomev4.tradesomev4.Filters.FollowersFilter;
 ...
 */
public class FollowersAdapter extends RecyclerView.Adapter<FollowersAdapter.FollowersHolder> implements Filterable {
    ...
    public FollowersAdapter(Context context, String uid, boolean isAttached, RecyclerView recyclerView, RequestManager glide,
    ...
    public Filter getFilter() {
        if (filter == null) {
            filter = new FollowersFilter(followers, this);
        }
    ...
    class FollowersHolder extends RecyclerView.ViewHolder {
        ...
        public FollowersHolder(View itemView) {
            ...
            image = (ImageView) itemView.findViewById(R.id.iv_followers_image);
        }
    }
}
